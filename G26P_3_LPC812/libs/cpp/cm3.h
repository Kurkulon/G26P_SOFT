...
//brief  Structure type to access the Nested Vectored Interrupt Controller (NVIC).
	...
	typedef struct
	{
		IO32 ISER[8];       // Interrupt Set Enable Register           
		u32 RESERVED0[24];
		IO32 ICER[8];       // Interrupt Clear Enable Register         
		u32 RSERVED1[24];
		IO32 ISPR[8];       // Interrupt Set Pending Register          
		u32 RESERVED2[24];
		IO32 ICPR[8];       // Interrupt Clear Pending Register        
		u32 RESERVED3[24];
		IO32 IABR[8];       // Interrupt Active bit Register           
		u32 RESERVED4[56];
		IO8  IP[240];       // Interrupt Priority Register (8Bit wide) 
		u32 RESERVED5[644];
		O32 STIR;			// Software Trigger Interrupt Register     
	}  NVIC_T;

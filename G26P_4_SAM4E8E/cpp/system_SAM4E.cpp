...
extern "C" void SystemInit (void)
{
	...
	PMC->PCER0 = PID::PIOA_M|PID::PIOB_M|PID::PIOC_M|PID::PIOD_M|PID::PIOE_M|PID::UART0_M|PID::UART1_M|PID::DMAC_M;
	...
	PIOA->ABCDSR2 =	0x00000000;	// 0000 0000 0000 0000 0000 0000 0110 0000		
	...
	PIOA->SODR = (0xF<<13)|(0xF<<23);
								...
								// 1  8 7  4 3  0 9  6 5  2 1  8 7  4 3  0								
	PIOB->PDR =		0x00000000;	// 0000 0000 0000 0000 0000 0000 0000 0000
	...
	PIOC->OER = 	0x00000000;	// 0000 0000 0000 0000 0000 0000 0000 0000		
								...
								// 1  8 7  4 3  0 9  6 5  2 1  8 7  4 3  0								
	PIOD->PDR =		0x0001FFFF;	// 0000 0000 0000 0001 1111 1111 1111 1111
	...
	PIOD->PER = 	0x22040000;	// 0010 0010 0000 0100 0000 0000 0000 0000		
	PIOD->OER = 	0x20040000;	// 0010 0000 0000 0100 0000 0000 0000 0000	

	PIOD->CODR = 1<<29; // PHY_RST

...
extern "C" void SystemInit (void)
{
	...
	PIOA->PDR =		0x01003660;	// 0000 0001 0000 0000 0011 0110 0110 0000
	...
	PIOA->PER = 	0xFEFFC99F;	// 1111 1110 1111 1111 1100 1001 1001 1111		
	PIOA->OER = 	0xFEFFC99F;	// 1111 1110 1110 1111 1100 1001 1001 1111		
	...
	PIOB->OER = 	0x00006D02;	// 0000 0000 0000 0000 0110 1101 0000 0010		
...
static void InitManRecieve()
{
	...
	PMC->PCER0 = PID::TC1_M|PID::PIOB_M;

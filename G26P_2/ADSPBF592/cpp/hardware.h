...
inline void ManDisable() { *pPORTFIO_CLEAR = 0xA0; *pPORTFIO_SET = 0x50; }
inline void ManOne() { *pPORTFIO_CLEAR = 0xA0; *pPORTFIO_SET = 0x50; *pPORTFIO_CLEAR = 0xC0; *pPORTFIO_SET = 0x30; }
inline void ManZero() { *pPORTFIO_CLEAR = 0xA0; *pPORTFIO_SET = 0x50; *pPORTFIO_CLEAR = 0x30; *pPORTFIO_SET = 0xC0; }

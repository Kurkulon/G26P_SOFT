...
bool InitEMAC()
{
  ...
  //  HW::PPB->CCR &= ~PPB_CCR_UNALIGN_TRP_Msk;
    ...
    HW::SCU_CLK->CLKSET = SCU_CLK_CLKSET_ETH0CEN_Msk;

    HW::PORT15->PDISC &= ~(PORT15_PDISC_PDIS8_Msk | PORT15_PDISC_PDIS9_Msk);
	HW::ETH0_CON->CON = CON_INFSEL|CON_RXD0(0)|CON_RXD1(0)|CON_CLK_RMII(2)|CON_CRS_DV(2)|CON_RXER(0)|CON_MDIO(1);

	HW::SCU_CLK->CGATCLR2 = SCU_CLK_CGATCLR2_ETH0_Msk;
//	HW::SCU_RESET->PRSET2 = SCU_RESET_PRSET2_ETH0RS_Msk;
	HW::SCU_RESET->PRCLR2 = SCU_RESET_PRCLR2_ETH0RS_Msk;
...
//	WritePHY(PHY_REG_PHYCON2, PHYCON2_HP_MDIX |  PHYCON2_JABBER_EN | PHYCON2_RMII_REF_CLK_SEL);

//	WritePHY(PHY_REG_ANAR, ANAR_100BTX_FD |  ANAR_100BTX | ANAR_10BT_FD | ANAR_10BT | ANAR_SELECTOR0);
